package emi.testing_mod.structures;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import emi.testing_mod.TestingModStructures;
...
public class CrystalGrowthStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<CrystalGrowthStructures> CODEC = RecordCodecBuilder.<CrystalGrowthStructures>mapCodec(instance ->
            instance.group(CrystalGrowthStructures.configCodecBuilder(instance),
            ...
            ).apply(instance, CrystalGrowthStructures::new)).codec();
    ...
    public CrystalGrowthStructures(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!CrystalGrowthStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        ...
        return TestingModStructures.CRYSTAL_GROWTH_STRUCTURES; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
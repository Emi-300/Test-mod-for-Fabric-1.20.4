...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<ReactorCoreEntity> REACTOR_CORE_ENTITY =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(Testing_mod.MOD_ID,"laser_core_be"),
                    BlockEntityType.Builder.create(ReactorCoreEntity::new,
                            ModBlocks.REACTOR_CORE).build());
